...
Optional (for video transcription):
    ...
    - DEEPGRAM_API_KEY environment variable set (get a free key at https://deepgram.com)
"""
            ...
            for j, vid_url in enumerate(urls, 1):
                ...
                if download_video(vid_url, vid_filepath):
                    ...
                    if convert_mp4_to_mp3(vid_filepath, mp3_filepath):
                        ...
                        lines.append("*Audio extraction failed*")
                else:
...
def main():
    ...
    if not DEEPGRAM_API_KEY:
        print("[ads-spy] Warning: DEEPGRAM_API_KEY not set — video transcription will be skipped")
